...
-- データベースの作成
CREATE DATABASE IF NOT EXISTS hajime_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE hajime_db;
...
<p>管理画面にアクセスするには、<a href="/hajime/admin/">こちら</a>をクリックしてください。</p>',
    'default',
    'published',
    'ホーム - Hajime CMS',
...
(
    '私たちについて',
    'about',
    '<h2>Hajime CMSについて</h2>
<p>Hajime CMSは、PHPとMySQLで構築された軽量なコンテンツ管理システムです。</p>
